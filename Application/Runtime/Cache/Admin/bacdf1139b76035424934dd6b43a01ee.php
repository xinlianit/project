							...
							<div class="col-xs-12">
								...
								<div class="table-responsive">
									...
									<div class="table-search">
										<div class="form-group">
											<span class="input-group-btn search-btn">
												<button event-name="addDevice" type="button" class="btn btn-sm btn-success">
													新增设备
	...
	<form class="form-horizontal" role="form" form-id="add" action="<?php echo U('Shop/add');?>" method="post">
		<div tag-id="setup-1">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="hotel_name" placeholder="输入房间号" class="col-xs-10 col-sm-9" style="width:42%;">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="hotel_name" placeholder="输入房间电话号码" class="col-xs-10 col-sm-9" style="width:42%;">
				</div>
			</div>
		</div>
	</form>
